...
import 'classroom tabs/student_reading_progress_page.dart';
...
class _ClassDetailsPageState extends State<ClassDetailsPage> {
  ...
  Uint8List? _previewBytes; // web & mobile preview
  ...
  Future<void> _pickAndUploadBackground() async {
    ...
    final confirmUpdate = await _showImagePreviewDialog(bytes);
    ...
    try {
      final response = await ClassroomService.uploadClassBackground(
        ...
        fileBytes: bytes,
        fileName: pickedFile.name, // XFile.name works on web
      );
  ...
  Future<bool?> _showImagePreviewDialog(Uint8List imageBytes) {
    return showDialog<bool>(
      context: context,
      builder:
          (ctx) => Dialog(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  ...
                  background: FutureBuilder<String>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      // REPLACE the ImageProvider block:
